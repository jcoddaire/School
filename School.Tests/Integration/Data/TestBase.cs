...
namespace School.Tests.Integration.Data
{
    ...
    {        
        ...
        const string TEST_CONNECTION_STRING = @"Data Source=localhost;Initial Catalog=School;Integrated Security=True;MultipleActiveResultSets=True;App=EntityFramework";
